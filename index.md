...
**INTERESTING MASTER THESIS PROJECT!** We are currently looking for one or two students for an [academic master thesis project](https://bagmark.files.wordpress.com/2023/09/masterthesis_proposal_deeplearningfiltering.pdf) on Bayesian filtering using the so called deep splitting method. The project requires some familiarity with stochastic analysis, Bayesian statistics and deep learning. 
