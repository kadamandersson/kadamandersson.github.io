<img align = "left" style = "float:left; padding: 0px 20px 10px 0px" src="adamandersson2.JPG" width="220">
...
- A. A., K. Andersson, P. Ljung, Convergence of fictitious play for fully coupled FBSDE in finite-player stochastic differential games, 2026. [PDF](https://arxiv.org/pdf/2607.08861)
...
- **Introduction to stochastic control and filtering**, 2025. [PDF](LN_ISCF.pdf)
...
- **[Kasper Bågmark](https://bagmark.github.io)** [Learning to estimate: Bayesian filtering with deep density methods](https://research.chalmers.se/en/publication/551750). Chalmers 2026. Kasper continued as a WASP-KAW funded postdoc at Vrije Universiteit Amsterdam working with uncertainty quantification for mathematical neuroscience with scientific machine learning. 
...
- **Isak Wikman** and **Samuel Winqvist** [Prospects of neural SDE for Bayesian smoothing](https://odr.chalmers.se/server/api/core/bitstreams/25cab526-76e6-4adf-bb5f-27080febee7a/content). Chalmers/Saab 2024. Isak continued as a radar system engineer at Saab and Samuel continued as junior game mathematician at Thunderkick.
...
- **Robin Andersson** [Sparse representation and image classification with the shearlet transform](https://www.math.chalmers.se/~mohammad/Mystudents/Robin.pdf), Chalmers/Syntronic 2017. Robin continued as algorithm developer at Syntronic.
